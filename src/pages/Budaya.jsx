...
const sasiranganData = [
  {
    ...
    hex: '#F4C038',
    image: 'https://images.unsplash.com/photo-1528459801416-a9e53bbf4e17?auto=format&fit=crop&w=800&q=75',
  ...
  },
  {
    ...
    hex: '#00A896',
    image: 'https://images.unsplash.com/photo-1606744824163-985d376605aa?auto=format&fit=crop&w=800&q=75',
  ...
  },
  {
    ...
    hex: '#E63946',
    image: 'https://images.unsplash.com/photo-1579783900882-c0d3dad7b119?auto=format&fit=crop&w=800&q=75',
  ...
  },
  {
    ...
    hex: '#8D5B4C',
    image: 'https://images.unsplash.com/photo-1501339847302-ac426a4a7cbb?auto=format&fit=crop&w=800&q=75',
...
const seniPertunjukanData = [
  {
    ...
    image: 'https://images.unsplash.com/photo-1485278537138-4e8911a13c02?auto=format&fit=crop&w=600&q=75',
  ...
  },
  {
    ...
    image: 'https://images.unsplash.com/photo-1511671782779-c97d3d27a1d4?auto=format&fit=crop&w=600&q=75',
  ...
  },
  {
    ...
    image: 'https://images.unsplash.com/photo-1465847899084-d164df4dedc6?auto=format&fit=crop&w=600&q=75',
...
const mobileLookbookItems = [
  {
    ...
    img: 'https://images.unsplash.com/photo-1534528741775-53994a69daeb?auto=format&fit=crop&w=800&q=75'
  },
  {
    tabName: '✨ Wastra Adat',
    ...
    img: 'https://images.unsplash.com/photo-1528459801416-a9e53bbf4e17?auto=format&fit=crop&w=800&q=75'
  },
  {
    ...
    img: 'https://images.unsplash.com/photo-1476514525535-07fb3b4ae5f1?auto=format&fit=crop&w=800&q=75'
  },
  {
    tabName: '🎵 Seni Lisan',
    ...
    img: 'https://images.unsplash.com/photo-1485278537138-4e8911a13c02?auto=format&fit=crop&w=800&q=75'
  }
];
        ...
        <div className="hidden md:grid grid-cols-5 gap-6 items-center relative">
          ...
          <div className="col-span-1 flex flex-col justify-center">
            <div className="relative rounded-[32px] overflow-hidden h-[260px] bg-amber-500/10 border border-[var(--glass-border)] shadow-md group hover:border-[#F4C038] transition-all duration-200">
              <img
                src="https://images.unsplash.com/photo-1528459801416-a9e53bbf4e17?auto=format&fit=crop&w=500&q=75"
          ...
          <div className="col-span-1 flex flex-col gap-4">
            <div className="relative rounded-2xl overflow-hidden h-[160px] bg-teal-500/10 border border-[var(--glass-border)] shadow-md group hover:border-[#33C3B3] transition-all duration-200">
              <img
                src="https://images.unsplash.com/photo-1476514525535-07fb3b4ae5f1?auto=format&fit=crop&w=500&q=75"
            ...
            <div className="relative rounded-2xl overflow-hidden h-[160px] bg-yellow-500/10 border border-[var(--glass-border)] shadow-md group hover:border-[#F4C038] transition-all duration-200">
              <img
                src="https://images.unsplash.com/photo-1501339847302-ac426a4a7cbb?auto=format&fit=crop&w=500&q=75"
          ...
          <div className="col-span-1 flex flex-col gap-4">
            <div className="relative rounded-2xl overflow-hidden h-[160px] bg-orange-500/10 border border-[var(--glass-border)] shadow-md group hover:border-[#F4C038] transition-all duration-200">
              <img
                src="https://images.unsplash.com/photo-1507679799987-c73779587ccf?auto=format&fit=crop&w=500&q=75"
            ...
            <div className="relative rounded-2xl overflow-hidden h-[160px] bg-sky-500/10 border border-[var(--glass-border)] shadow-md group hover:border-[#33C3B3] transition-all duration-200">
              <img
                src="https://images.unsplash.com/photo-1485278537138-4e8911a13c02?auto=format&fit=crop&w=500&q=75"
          ...
          <div className="col-span-1 flex flex-col justify-center relative">
            ...
            <div className="relative rounded-[32px] overflow-hidden h-[260px] bg-emerald-500/10 border border-[var(--glass-border)] shadow-md group hover:border-[#33C3B3] transition-all duration-200">
              <img
                src="https://images.unsplash.com/photo-1579783900882-c0d3dad7b119?auto=format&fit=crop&w=500&q=75"
                alt="Seni Kalimantan"
                loading="lazy"
                decoding="async"
                className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500"
      ...
      <section className="py-16 max-w-[1240px] mx-auto px-4 border-t border-[var(--glass-border)]">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
          <div className="lg:col-span-7 relative rounded-[36px] overflow-hidden border border-[var(--glass-border)] shadow-md bg-slate-900 h-[360px] md:h-[480px]">
            <img
              src="https://images.unsplash.com/photo-1507679799987-c73779587ccf?auto=format&fit=crop&w=1000&q=75"
