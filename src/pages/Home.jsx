              ...
              <div
                ...
                className={`relative overflow-hidden transition-[flex] duration-500 ease-out select-none ${
                  isActive
                    ...
                    : "flex-[0.8] lg:flex-[1] cursor-pointer group border-r border-white/15 last:border-0 hover:flex-[1.2] transition-[flex] duration-300"
                }`}
              >
                <img loading={i === 0 ? "eager" : "lazy"} fetchpriority={i === 0 ? "high" : "auto"} decoding="async" src={item.img} alt={item.title} className={`absolute inset-0 w-full h-full object-cover transition-transform duration-700 ease-out ${isActive ? "scale-105 brightness-100" : "brightness-75 group-hover:scale-105 group-hover:brightness-90"}`} />
                {isActive ? (
                  <>
