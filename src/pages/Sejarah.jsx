...
const timelineData = [
  ...
  },
  {
    ...
    img: "https://images.unsplash.com/photo-1588615419951-af7cb7af766c?auto=format&fit=crop&w=800&q=80",
    tag: "Perdagangan"
  },
  {
    year: "1859",
  ...
  },
  {
    ...
    img: "https://images.unsplash.com/photo-1596401057633-54a8fe8ef647?auto=format&fit=crop&w=800&q=80",
    tag: "Modernitas"
  }
];
  ...
  return (
    <>
      ...
      <div className="bg-[var(--bg-main)] pt-24 pb-16 overflow-hidden relative border-b border-[var(--glass-border)]">
        ...
        <div className="max-w-[1400px] mx-auto px-4 relative min-h-[550px] lg:min-h-[650px] flex flex-col md:flex-row items-start justify-center pt-4 md:pt-10">
          ...
          <div className="hidden md:block absolute left-4 lg:left-10 top-8 w-full max-w-[300px]">
            ...
            />
            <HangingFrame 
              src="https://images.unsplash.com/photo-1590418606746-018840f988f0?auto=format&fit=crop&w=600&q=80" 
          ...
          <div className="hidden md:block absolute right-4 lg:right-10 top-0 w-full max-w-[300px]">
            <HangingFrame 
              src="https://images.unsplash.com/photo-1520645521318-f09a7a92fb04?auto=format&fit=crop&w=600&q=80" 
              className="absolute right-0 top-0"
              width="w-[200px] lg:w-[260px]"
              height="h-[280px] lg:h-[350px]"
            />
            <HangingFrame 
              src="https://images.unsplash.com/photo-1588615419951-af7cb7af766c?auto=format&fit=crop&w=600&q=80" 
            ...
            <div className="lg:col-span-7 grid grid-cols-2 gap-4 sm:gap-6">
              <div className="space-y-4 sm:space-y-6 pt-8 sm:pt-12">
                <div className="h-[200px] sm:h-[260px] rounded-3xl overflow-hidden shadow-xl border border-[var(--glass-border)] relative group">
                  <img src="https://images.unsplash.com/photo-1596401057633-54a8fe8ef647?auto=format&fit=crop&w=600&q=80" alt="Pasar Terapung" className="w-full h-full object-cover grayscale group-hover:grayscale-0 transition-all duration-500" />
              ...
              <div className="space-y-4 sm:space-y-6">
                ...
                <div className="h-[200px] sm:h-[260px] rounded-3xl overflow-hidden shadow-xl border border-[var(--glass-border)] relative group">
                  <img src="https://images.unsplash.com/photo-1544005313-94ddf0286df2?auto=format&fit=crop&w=600&q=80" alt="Sungai Martapura" className="w-full h-full object-cover grayscale group-hover:grayscale-0 transition-all duration-500" />
