        ...
        {blogs.length === 0 ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {blogs.map(blog => {
              ...
              return (
                <Link key={blog.id} href={`/${lang}/blog/${blog.slug}`} className="group bg-[var(--card-bg)] border border-[var(--glass-border)] rounded-3xl overflow-hidden hover:border-[#33C3B3] transition-all hover:-translate-y-2">
                  ...
                  <div className="p-6">
                    ...
                    <p className="text-[var(--text-muted)] text-sm line-clamp-3 mb-6">{excerpt}</p>
