...
export async function generateMetadata({ params }) {
  ...
  const seoDB = {
    id: {
      title: "Destinasi Wisata Unggulan & Susur Sungai | Visit Banjarmasin",
      description: "Jelajahi keajaiban Pasar Terapung Lok Baintan, Siring Menara Pandang, Patung Bekantan, hingga desa wisata susur sungai Martapura di Banjarmasin.",
    ...
    en: {
      title: "Top Tourist Destinations & River Tours | Visit Banjarmasin",
      description: "Explore the wonders of Lok Baintan Floating Market, Menara Pandang, Proboscis Monkey Statue, and authentic Martapura river cruise destinations.",
    ...
    ms: {
      title: "Destinasi Pelancongan Menarik & Susur Sungai | Visit Banjarmasin",
      description: "Terokai keajaiban Pasar Terapung Lok Baintan, Siring Menara Pandang, Patung Bekantan, hingga desa pelancongan menyusuri sungai Martapura di Banjarmasin.",
    ...
    zh: {
      title: "马辰顶级旅游目的地与水上市场游船指南 | Visit Banjarmasin",
      description: "探索班贾尔马辛热门旅游景点：Lok Baintan水上市场、Siring观景塔、长鼻猴雕像与马塔普拉河游船村，体验婆罗洲水上风情。",
