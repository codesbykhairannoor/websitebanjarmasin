export const id = {
  ...
  assistant: {
    welcome: "Halo sanak! Ulun Asisten Wisata Banjar 🧭✨ Siap memandu pian menjelajahi kuliner legendaris, wisata susur sungai, rute BRT, atau sejarah 1526. Ada yang handak ditanyakan?",
    thinking: "Asisten sedang mencari info...",
    rateLimit: "🛡️ SISTEM KEAMANAN: Deteksi pengiriman pesan terlalu cepat. Silakan tunggu beberapa saat atau hubungi WhatsApp Admin di bawah.",
    apiKeyWarning: "⚠️ API Key Gemini belum terdeteksi. Silakan hubungi Admin melalui tombol WA di bawah.",
    errorMessage: "Mohon maaf sanak, koneksi asisten sedang terkendala jaringan. Pian bisa langsung bertanya ke Admin melalui tombol WhatsApp di bawah ini ya! 🙏",
    waButton: "Hubungi WA Admin Manusia",
    placeholder: "Ketik pertanyaan wisata...",
    title: "Asisten Wisata Banjar",
    badge: "AI Guide",
